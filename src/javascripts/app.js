...
$(document).ready(function() {
  ...
  if ($form.length > 0) {
    $('form input[type="submit"]').bind('click', function(event) {
      console.log('i clicked something', $form[0][0].value);
      console.log('this is the form action url', $form.attr('action'));
...
var showError = function(field, error) {
  ...
  if (!message) {
    ...
    if (!label) {
      // field.parentNode.insertBefore(message, field.parentNode);
